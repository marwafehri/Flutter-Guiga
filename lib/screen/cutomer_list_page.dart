...
class CustomerListPageState extends State<CustomerListPage> {
 // late Widget _mainFormWidget; // Save the form
 ...
 // var bloc; // Associate bloc
  ...
  late CustomerListBloc bloc; // Associate bloc
  ...
  Widget build(BuildContext context) {
    ...
    // Check if _mainFormWidget is an empty widget
   // if (_mainFormWidget is SizedBox && (_mainFormWidget as SizedBox).shrinkWrap) {
     // _mainFormWidget = mainBody();
    //}
    print(_mainFormWidget);
    print("_mainFormWidget");
